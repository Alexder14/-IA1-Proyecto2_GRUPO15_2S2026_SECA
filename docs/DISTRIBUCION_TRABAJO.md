...
Tareas de cada quien hasta la entrega en [COMENZAR.md](COMENZAR.md).
Detalle de fases, contratos y riesgos en [PLANIFICACION.md](PLANIFICACION.md).
...
| P5 | | | RPA, infraestructura y documentación | `aura/rpa/`, `scripts/`, `docs/` |
